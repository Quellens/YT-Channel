...
var rightpressed = false, leftpressed = false, enterpressed = false, shiftpressed = false;
var count = 0;
...
backgroundMusic.src = "Astronomia%20with%20D%C3%A4vid.mp3";
...
function drawPotion(){
    c.beginPath()
     mobiledevice ? c.drawImage(healing_potion,potionx,potiony, 80,80):
